...
class ChecksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create check" do
    assert_difference('Check.count') do
      post checks_url, params: { check: { direction: @check.direction, employee_id: @check.employee_id, time: @check.time } }
    end
  ...
  test "should update check" do
    patch check_url(@check), params: { check: { direction: @check.direction, employee_id: @check.employee_id, time: @check.time } }
